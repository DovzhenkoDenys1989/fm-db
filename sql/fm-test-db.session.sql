...
SET "height" = 1.75
WHERE "firstname" = 'Sophia'
RETURNING "id", "firstname", "height";
/* */
UPDATE "users"
SET "firstname" = 'Test', "lastname" = 'Testovich'
WHERE "id" = 2000;
/* */
SELECT * FROM "users"
WHERE "id" = 2000;
...
SELECT *
FROM "users"
WHERE "is_male" = FALSE AND AGE("birthday") > MAKE_INTERVAL(30);
/* */
SELECT *
FROM "users"
...
SELECT *
FROM "users"
WHERE AGE("birthday") > MAKE_INTERVAL(20) AND "height" > 1.8;
/* */
SELECT *
FROM "users"
...
/* */
DELETE FROM "users" WHERE AGE("birthday") < MAKE_INTERVAL(30);
/* */
...
/* */
 SELECT "firstname", COUNT("id") AS "count_people"
 FROM "users"
...
/* */
 ...
 FROM "users"
 GROUP BY "firstname"
 ORDER BY "count_people" DESC, "firstname" ASC
 LIMIT 10;
 /* */
/* */
 SELECT * 
 ...
 */
 ...
 SELECT *
 FROM "users"
 ORDER BY "birthday" DESC, "weight", "height" DESC;
 /* */
